...
contract BookStore is ERC1155 {
    ...
    function transferFromAuthor(address buyer, uint256 _bookVersionId) public {
        require(msg.sender == address(_storeFront), "Method can only e called by Store From contract");
        BookVersion memory bookVersion = _bookVersions[_bookVersionId];
        safeTransferFrom(bookVersion.author, buyer, _bookVersionId, 1, "");
    }
